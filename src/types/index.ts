...
export interface YearThemeInput {
  year: number;
  theme?: string | null;
  focus_areas?: string[];
  non_focus_areas?: string[];
...
// Yearly Goals for Calendar
export type YearGoalDataSource = 'manual' | 'habit';
...
export interface YearGoal {
  ...
  completed: boolean;
  completed_at: string | null;
  data_source: YearGoalDataSource;
  linked_habit_id: string | null;
  auto_sync: boolean;
  display_order: number;
  created_at: string;
